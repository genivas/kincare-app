      ...
      <header className="px-4 mb-6 flex justify-between items-start">
        <div className="flex items-center gap-4">
          <div style={{position: 'relative'}}>
            <img src={patient.avatar} alt="Avatar" className="avatar" style={{width: '64px', height: '64px', borderRadius: '24px', boxShadow: '0 8px 16px rgba(0,0,0,0.08)', border: 'none'}} />
          ...
          <div className="flex-1">
            <h1 style={{fontSize: '1.4rem', fontWeight: '700', letterSpacing: '-0.5px', marginBottom: '0.2rem', lineHeight: '1.2'}}>{patient.name}</h1>
        ...
        <section className="flex gap-3 mb-6">
          <div className="glass-card flex-1 mb-0" style={{padding: '1.25rem'}}>
            ...
            <div className="flex items-center gap-3 mt-3">
              <img src={todayCaregiver?.avatar} alt={todayCaregiver?.name} style={{width: '44px', height: '44px', borderRadius: '14px', objectFit: 'cover'}}/>
              <div>
                <strong style={{fontSize: '1rem', display: 'block', color: 'var(--primary-color)'}}>{todayCaregiver?.name}</strong>
